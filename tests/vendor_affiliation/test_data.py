# Vendored test from affiliation-metrics-py (MIT); imports rewritten. See
# src/telemeval/metrics/_affiliation_vendor/VENDORED.md.
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
import unittest
...
from telemeval.metrics._affiliation_vendor.generics import (
        ...
        f1_func)
from telemeval.metrics._affiliation_vendor.metrics import produce_all_results
