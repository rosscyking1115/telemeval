# Vendored from https://github.com/ahstat/affiliation-metrics-py (MIT License,
# Copyright (c) 2022 Alexis Huet and others). Modification from upstream: import
# paths rewritten from 'affiliation.' to 'telemeval.metrics._affiliation_vendor.'
# for vendoring. See VENDORED.md and the LICENSE file in this directory.
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
from telemeval.metrics._affiliation_vendor.generics import (
        infer_Trange,
        has_point_anomalies, 
        _len_wo_nan, 
        _sum_wo_nan,
        read_all_as_events)
from telemeval.metrics._affiliation_vendor._affiliation_zone import (
        get_all_E_gt_func, 
        affiliation_partition)
from telemeval.metrics._affiliation_vendor._single_ground_truth_event import (
